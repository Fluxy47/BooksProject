...
function Navigation() {
  ...
  const handleClick3 = () => {
    navigate("/Atomic-Habit");
    setShowText(false);
  };
  const handleClick4 = () => {
    navigate("/Mindset:The-New-Psychology-of-Success");
    setShowText(false);
  };
  const handleClick5 = () => {
    navigate("/How-to-Win-Friends-and-Influence-People");
    setShowText(false);
  };
          ...
          >
            <Tilt>
              <motion.div
                ...
                transition={{ ease: [0.6, 0.01, -0.05, 0.95], duration: 1.6 }}
                className="w-[100vw] md:w-[30vw] h-[30vh] bg-[#AF6E6E] flex-none cursor-pointer rounded-xl mt-5 mb-[20vh] md:mb-0"
              />
              <motion.h1
                exit={{ opacity: 0 }}
                transition={{ duration: 0.5 }}
