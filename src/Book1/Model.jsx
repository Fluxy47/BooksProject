  ...
  return (
    ...
    >
      <div className="flex w-full">
        <motion.div
          className=" w-2/5 h-screen hidden lg:block mx-3"
          variants={MImage}
          animate={controls}
          transition={{
            duration: 1,
        ...
        <div className=" w-full lg:w-3/5">
          ...
          <motion.p
            variants={Mtext}
            animate={controls}
            className="text-center  font-semibold mb-[10px] mx-2"
          >
          ...
          <motion.p
            ...
            animate={controls}
            transition={{ delay: 0.2 }}
            className="text-center text-[1.1em] text-[silver] mb-[10px] mx-3"
          >
          ...
          <motion.p
            ...
            className="text-center text-[1.1em] text-[silver] mx-3"
          >
