    ...
    <section className="w-full h-auto " ref={element} data-scroll-section>
      ...
      <div className="flex flex-col h-full w-full">
        <motion.div
          ...
          className="text-center  text-[2em] md:text-[3.5em] pb-[200px] lg:pb-[250px] text-[#C0C0C0] mx-2"
        >
        ...
        <motion.div
          ...
          className="text-center text-[2em] md:text-[3.5em] pb-[150px] lg:pb-[250px] text-[#C0C0C0] mx-2"
        >
        ...
        <motion.div
          ...
          data-scroll-direction="vertical"
          data-scroll-delay="1"
          className="text-center text-[2em] md:text-[3.5em] text-[#C0C0C0] pb-[20%] mx-2"
        >
