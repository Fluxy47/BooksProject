...
function Modal({ selected, clickFunc2, isShow }) {
  ...
  switch (selected.id) {
    case 1:
      contentToRender = (
        <div className="fixed z-[60]   h-screen w-full flex flex-col ">
          <h1 className="text-[3em] text-center text-[silver] font-bold mt-[75px] md:0">
            Atomic Habits
          </h1>
    ...
    case 2:
      ...
      contentToRender = (
        <div className="fixed  h-screen w-full overflow-y-auto">
          <div className="flex flex-col mb-5 mt-[75px] md:mt-0">
            ...
            <div className="flex flex-col gap-[10vh] lg:flex-row  justify-center items-center">
              ...
              <div className="bg-[#100B2E] border-2 border-[#A5CC6B] w-[20em] md:w-[40vw] lg:w-[20em] h-[500px]">
                ...
                <p className="text-[1.3em] text-center mx-1">
              ...
              <div className="bg-[#100B2E] border-2 border-[#A5CC6B] w-[20em] md:w-[40vw] lg:w-[20em] h-[500px]">
                ...
                <p className="text-[1.2em] text-center mx-2">
              ...
              <div className="bg-[#100B2E] border-2 border-[#A5CC6B] w-[20em] md:w-[40vw] lg:w-[20em] h-[500px] ">
                ...
                <p className="text-[1.3em] text-center mx-2">
                  {" "}
    ...
    case 3:
      contentToRender = (
        <div className="fixed z-[60]  h-screen w-full ">
          <div className="flex w-full mt-[75px] md:mt-0">
            <motion.div
            ...
            <div className=" w-full lg:w-3/5 h-screen ">
              ...
              <motion.p
                className=" text-[1em] lg:text-[1.5em] text-black font-bold text-center mx-2 md:mt-10 pb-[20px]"
                variants={Mtext}
                initial="hidden"
                animate="show"
                exit="exit"
              ...
              <div className="max-h-[70vh] lg:max-h-auto overflow-y-auto">
                <ul className="text-[1.1em] lg:text-[1.5em] list-disc list-inside">
                  {bullet.map((bullet, index) => (
                    <li
                      ...
                      className="mb-3 mx-2 text-center font-semibold text-[1.1em] md:text-[1.2em]"
                    >
                      {bullet}
                    </li>
                  ))}
    ...
    case 4:
      contentToRender = (
        <div className="fixed z-[70]   h-screen w-full overflow-y-auto md:overflow-hidden">
          <div className="flex flex-col mt-[75px] md:mt-0 md:pb-[10%]">
            <h1
              style={{
                textShadow: "2px 2px 4px rgba(0, 0, 0, 0.5)",
              }}
    ...
    case 5:
      contentToRender = (
        <div className="fixed z-[60]    h-screen w-full overflow-y-auto md:overflow-hidden">
          <div className="flex flex-col mt-[75px] md:mt-0 md:pb-[10%]">
            <h1
              style={{
                textShadow: "2px 2px 4px rgba(0, 0, 0, 0.5)",
  ...
  return (
    <motion.div
      className="absolute  bg-opacity-50 top-0 left-0 right-0 bottom-0  h-full w-full  z-[60]"
    ...
    >
      ...
      <div className="fixed top-2 left-2 z-[70] flex  ">
        <motion.button
          initial={{ opacity: 0 }}
          animate={{ opacity: isShow ? 1 : 0 }}
          exit={{ opacity: 0 }}
